...
\section{Technlogies alternatives pour transmetre de l'energie \cite{wiki5}}
  Contrairment a transmettre directement de l'electricité directement , il est possible de transmettre d'autres formes d'energie tel que les lasers , étant possiblement plus efficace , quoique la conversion electricté/lumierere/électricité est surement source de nombreuses pertes , mais contrairement aux champs magnétiques aggisant sur une distance de quelques métres , on peut transmettre des lasers sans trop de problemes sur quelques kilométres , si toutefois il y a ligne de vue ce qui peut etre difficile parfois. A la place des lasers on peut aussi utiliser des micro-ondes , ceci traversant mieux les obstacles semi opaques , au détriment d'une portée moindre , de l'orde de la centaine de métre pour que le systeme reste d'une taille pratique. Les conversions des lasers et des micros ondes sont de 50\% , mais les lasers peuvent etre totalemant bloqués par la pluie ou le brouillard , mais ne subissent pas d'interfrences d'autre systemes electro-magnetiques.
